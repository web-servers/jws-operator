...
func (r *ReconcileWebServer) generateObjectMeta(webServer *webserversv1alpha1.WebServer, name string) metav1.ObjectMeta {
...
func (r *ReconcileWebServer) generateEnvBuild(webServer *webserversv1alpha1.WebServer) []corev1.EnvVar {
...
func (r *ReconcileWebServer) generateBuildTriggerPolicy(webServer *webserversv1alpha1.WebServer) []buildv1.BuildTriggerPolicy {
...
// shell -c "command"
func (r *ReconcileWebServer) generateLivenessProbe(webServer *webserversv1alpha1.WebServer, health *webserversv1alpha1.WebServerHealthCheckSpec) *corev1.Probe {
	livenessProbeScript := ""
	if health != nil {
...
// complies to the Kubernetes probes requirements and use the following format
// shell -c "command"
func (r *ReconcileWebServer) generateReadinessProbe(webServer *webserversv1alpha1.WebServer, health *webserversv1alpha1.WebServerHealthCheckSpec) *corev1.Probe {
...
func (r *ReconcileWebServer) generateCustomProbe(webServer *webserversv1alpha1.WebServer, probeScript string) *corev1.Probe {
...
func (r *ReconcileWebServer) generateVolumeMounts(webServer *webserversv1alpha1.WebServer) []corev1.VolumeMount {
...
// Create the Volumes
func (r *ReconcileWebServer) generateVolumes(webServer *webserversv1alpha1.WebServer) []corev1.Volume {
