...
var _ = Describe("WebServer controller", func() {
	Context("WebServerApplicationImageBasicTest", func() {
		It("WebServerApplicationImageBasicTest", func() {
			...
			Expect(webserverstests.WebServerApplicationImageBasicTest(k8sClient, ctx, thetest, "default", "jfctest", "registry.redhat.io/jboss-webserver-5/webserver54-openjdk8-tomcat9-openshift-rhel8", "/health")).Should(Succeed())
			...
			// Expect(webserverstests.WebServerApplicationImageSourcesBasicTest(k8sClient, ctx, thetest, "default", "sourcesbasictest", "quay.io/jfclere/tomcat10:latest", "https://github.com/jfclere/demo-webapp", "jakartaEE", "/demo")).Should(Succeed())
			// Expect(webserverstests.WebServerApplicationImageSourcesScaleTest(k8sClient, ctx, thetest, "default", "sourcesscaletest", "quay.io/jfclere/tomcat10:latest", "https://github.com/jfclere/demo-webapp", "jakartaEE", "/demo")).Should(Succeed())
